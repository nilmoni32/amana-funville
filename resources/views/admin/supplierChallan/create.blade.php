            ...
            if($.trim($('#search_requisition_no').val()) != ""){ 
                ...
                $.ajax({
                        ...
                        success: function(data) {                            
                            ...
                            if(requisition){
                                let remarks = requisition.remarks != null ? 'Received' : new Date(requisition.expected_delivery) < new Date() ? 'Delivery Date Over' : '<button data-dismiss="modal" class="btn select-btn py-1" id="select'+requisition.id +'">Select</button>';
