...
<head>
    ...
    <title>Report [Ingredient-Purchase] - {{ config('app.name', 'Funville') }}</title>
    <style>
        body{
    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left" style="width:100%;">
                <h6 style="margin-top:5px; text-align: left;">MIS Report: Ingredient Purchase Details</h6>
            ...
            <div class="invoice-left-top float-left" style="width:100%;">
                ...
                <p class="text-left" style="margin-top:5px;">
                    <div style="line-height: 20px; font-weight:700;">
                        <span>Total Purchase Amount </span><span style="padding-left: 5px;">:</span> {{ round($purchase_total,2) }} {{ config('settings.currency_symbol') }}
                    </div>                                   
                </p>
            </div>
            <div class="clearfix"></div>
