...
<head>
    ...
    <title>Customer wise sales - {{ config('app.name', 'Funville') }}</title>
    <style>
        body{
    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left" style="width:100%;">
                <h5 style="margin-top:5px; text-align: left;">Report: Customer wise sales</h5>
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left" style="width:100%;">
                <h6 style="margin-top:5px;text-align: left;">Customer<span style="padding-left: 20px;">:</span> {{ $client->name }}</h6>
                <p class="text-left" style="margin-top:-5px;">
                <span>Earned Points </span><span style="padding-left: 3px;">:</span> {{ $client->total_points }} <br/>
                <span>Mobile No</span><span style="padding-left: 30px;">:</span>  {{ $client->mobile }} <br/>
                <span>Address</span><span style="padding-left: 41px;">:</span>  {{ $client->address }} <br/>
            </p>
            </div>
            <div class="clearfix"></div>
        </div>
        <div class="product-description" style="margin-top:-10px;">
            <table>
                ...
                <tbody>
                    @foreach($customer_receipts as $receipt)                   
                    <tr>
