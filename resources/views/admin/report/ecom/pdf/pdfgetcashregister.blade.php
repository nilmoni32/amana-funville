...
<head>
    ...
    <title>Ecom Cash register wise sale - {{ config('app.name', 'Funville') }}</title>
    <style>
        body{
    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left" style="width:100%;">
                <h5 style="margin-top:5px; text-align: left;">Report: E-Commerce Cash register wise sales</h5>
        ...
        <div class="mt-5" style="width:100%;">
            <p class="text-left" style="margin-top:5px;">
                ...
                <span>Net Cash Sales</span><span style="padding-left: 71px;">:</span>  {{ round($cash_sales,2) }} {{ config('settings.currency_symbol') }}<br/>
                <span>Net Card Sales</span><span style="padding-left: 73px;">:</span>  {{ round($card_sales,2) }} {{ config('settings.currency_symbol') }}<br/>
                <span>Net Mobile Banking Sales</span><span style="padding-left: 13px;">:</span>  {{ round($mobile_sales,2) }} {{ config('settings.currency_symbol') }}<br/>
                <span>Net Internet Banking Sales</span><span style="padding-left: 7px;">:</span>  {{ round($ib,2) }} {{ config('settings.currency_symbol') }}<br/>
            </p>
            <div class="clearfix"></div>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{  date("d-m-Y", strtotime($cash->order_date))}}</td>
