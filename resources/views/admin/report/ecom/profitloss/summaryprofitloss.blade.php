    ...
    <div class="col-md-12">
        <div class="tile">
            <div class="tile-body">
                ...
                @php $totalSalesCost +=$cart->salesCost;
                @endphp
                @endforeach                             
                <table class="table table-hover table-bordered" id="sampleTable">
                    ...
                    <tbody> 
                        <tr>
                            ...
                            <td class="text-center">
                                {{round(($total_sales - $totalSalesCost),2) }}
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5">
                                <div class="row h6">
                                    <div class="col-10 text-right">Net Total Sales [ including Shipping Cost + VAT ] :</div>
                                    <div class="col-2 pl-0"><span>{{ round($total_sales,2) }}</span><span class="ml-1 mr-2">{{ config('settings.currency_symbol') }}</span></div>                        
                                </div>
                                <div class="row h6">
                                ...
                                <div class="row h6">
                                    ...
                                    <div class="col-2 pl-0"><span>{{ round(($total_sales-$totalSalesCost) ,2) }}</span>
                                        <span class="ml-1 mr-2">{{ config('settings.currency_symbol') }}</span>
                                        &nbsp; {{ "( " . round((($total_sales - $totalSalesCost) / $totalSalesCost)*100,2) ."% )" }}
                                    </div>                        
                                </div>
                            </td>
                        </tr>
