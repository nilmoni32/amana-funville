...
<head>
    ...
    <title>Daily Sale - {{ config('app.name', 'Funville') }}</title>
    <style>
        .content-wrapper {
            margin-left: auto;
            margin-right: auto;
    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left">
                <h5 style="margin-top:10px;">Daily Top 20 Sale Reports</h5>
            </div>
            <div class="invoice-right-top float-right">
                <p style="margin-top:10px;">Date: <span
                        class="font-normal">{{ date('Y-m-d', strtotime("-1 days")) }}</span></p>
            </div>
            <div class="clearfix"></div>
        </div>
