                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="unit" id="unit" class="form-control">
                                        ...
                                        @endif --}}
                                        @if($purchase->unit =='pcs'|| $purchase->unit == 'bundle')
                                        <option value={{ $purchase->unit }} selected>{{ $purchase->unit }}</option>
                                        @elseif($purchase->unit == 'Kg')
                                        <option value={{ $purchase->unit }} selected>{{ $purchase->unit }}</option>
                                        <option value='gm'>gm</option>
                                        @elseif($purchase->unit == 'gm')
                                        <option value='Kg'>Kg</option>
                                        <option value={{ $purchase->unit }} selected>{{ $purchase->unit }}</option>
                                        @elseif($purchase->unit == 'liter')
                                        <option value={{ $purchase->unit }} selected>{{ $purchase->unit }}</option>
                                        <option value='ml'>ml</option>
                                        @elseif($purchase->unit == 'ml')
