            ...
            <form action=" {{ route('admin.categories.update') }} " method="POST" role="form" enctype="multipart/form-data">
                ...
                <div class="tile-body">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('category_name') is-invalid @enderror" type="text" name="category_name" id="category_name" value="{{ old('category_name', $targetCategory->category_name) }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control custom-select mt-15 @error('parent_id') is-invalid @enderror" id="parent" name="parent_id">                         
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" name="menu" id="menu" {{ $targetCategory->menu == 1 ? 'checked' : ''}}>Show in Menu                                
                            </label>
                        </div>
                    </div>                  
                    <div class="form-group">
