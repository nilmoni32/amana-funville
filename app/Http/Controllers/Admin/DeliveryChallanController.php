...
class DeliveryChallanController extends Controller
{
    ...
    public function getOnlyRequisition($id){
        ...
        foreach($items as $item){
            ...
            $productUnit = $supplier_stock->product_unit;
            ...
            $supplier_stock_unit = Unit::where('measurement_unit', $supplier_stock->has_differ_product_unit ? $supplier_stock->product_unit : $supplier_stock->measurement_unit)->first();
    ...
    public function store(Request $request){
        ...
        */       
        ...
        foreach($product_lists as $product){
            ...
            $receive_product->recipe_ingredient_unit = $product['recipe_unit'];
            ...
            $this->RecipeStockUpdate($supplier_stock->ingredient_id, $product['recipe_unit'], $product['recipe_stk_qty'], $product['total']);
    ...
    public function RecipeStockUpdate($ingredient_id, $purchase_unit, $purchase_qty, $purchase_price){
        ...
        if($ingredient->measurement_unit == $purchase_unit){
